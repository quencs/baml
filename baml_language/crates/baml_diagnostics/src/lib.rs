...
pub use compiler_error::{
    ColorMode, CompilerError, NameError, ParseError, SourceCache, TypeError, render_error,
    render_name_error, render_parse_error, render_report_to_string, render_type_error,
};
