...
use baml_compiler_hir::{self, FunctionBody as HirFunctionBody, ItemId, file_item_tree};
...
use baml_program::{
    ...
    LiteralValue, MediaKind, ParamDef, TestArgs, TestCaseDef, Ty,
};
...
fn compile_test(
    ...
    // TODO: Extract function and args from test definition
    Some(TestCaseDef {
        name: test.name.to_string(),
        function: String::new(), // TODO: Extract target function
        args: TestArgs::Literal(HashMap::new()), // TODO: Extract args
    })
}
