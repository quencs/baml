...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="./proposals/BEP-007-formatter/"><strong>BEP-007</strong>: Formatter</a> &nbsp; <img src="https://img.shields.io/badge/Status-Draft-lightgrey" alt="Draft"><br><br>The BAML formatter provides a canonical and easy way to format BAML code for better consistency and readability.<br><br><span style='font-size:0.8em; color:gray'>Shepherd(s): Avery Townsend <self@codeshaunted.com></span></td>
    </tr>
    <tr>
