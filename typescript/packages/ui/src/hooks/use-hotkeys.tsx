...
export function useHotkeys(keyBindingMap: KeyBindingMap, deps?: unknown[], props?: UseHotkeysProps) {
  useEffect(() => {
    ...
    const unsubscribe = tinykeys(props?.ref?.current ?? window, wrappedBindings, props)
