...
import { Toggle } from '@baml/ui/toggle'
      ...
      >
                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    {showCopied ? (
                      ...
                      <span className='text-sm hidden md:block'>Copy Prompt</span>
                    )}
                  </Button>
                </TooltipTrigger>
                <TooltipContent>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant='ghost' size='xs' className='flex gap-2 items-center text-muted-foreground/70'>
          ...
          <DropdownMenuContent align='start'>
            ...
            <DropdownMenuCheckboxItem checked={isParallelTestsEnabled} onCheckedChange={setIsParallelTestsEnabled}>
              <Split className='mr-2 size-4' />
              Enable Parallel Testing
            </DropdownMenuCheckboxItem>
            <DropdownMenuSeparator />
            <DropdownMenuLabel>Visualization</DropdownMenuLabel>
            <DropdownMenuCheckboxItem checked={isClientCallGraphEnabled} onCheckedChange={setIsClientCallGraphEnabled}>
