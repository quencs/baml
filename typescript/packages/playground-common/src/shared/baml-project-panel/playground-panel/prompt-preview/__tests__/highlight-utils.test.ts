...
describe('extractStringValues', () => {
  ...
  it('extracts plain string values', () => {
    ...
    expect(extractStringValues(inputs as any)).toEqual([he.encode('hello world')])
  })
  ...
  it('splits repeated text by 2+ spaces', () => {
    ...
    expect(extractStringValues(inputs as any)).toEqual([he.encode('foo'), he.encode('bar'), he.encode('baz')])
  })
