 ...
 *
 * Source: apps/baml-graph/src/sdk/atoms/derived.atoms.ts
 */
 ...
 * Source: derived.atoms.ts:91-104
 */
...
// Source: derived.atoms.ts:116-133
// ============================================================================

/**
 * The currently selected function (derived from node selection)
 *
 * Returns the function details for the selected node ID.
 * Null if nothing is selected or if selected node is not a function.
 *
 * NOTE: This is the graph-based selection. For string-based selection,
 * use selectedFunctionNameAtom from workflow.atoms.ts.
 */
export const selectedFunctionFromNodeAtom = atom((get) => {
...
// Source: derived.atoms.ts:148-178
// ============================================================================
...
export const isLLMOnlyModeAtom = atom((get) => {
  ...
  if (!isLLMFunction) {
    const selectedFunction = get(selectedFunctionFromNodeAtom);
