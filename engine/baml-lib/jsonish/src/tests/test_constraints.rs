...
test_deserializer_with_expected_score!(
    ...
    UNION_WITH_CHECKS,
    r#"{"bar": 5, "things":[]}"#,
    FieldType::Class("Either".to_string(), TypeMetadataIR::default()),
    3
);
...
test_deserializer_with_expected_score!(
    ...
    r#"{"inner": {"value": 15}}"#,
    FieldType::Class("Outer".to_string(), TypeMetadataIR::default()),
    1
);
...
test_failing_deserializer!(
    ...
    BLOCK_LEVEL,
    r#"THREE"#,
    FieldType::Enum("MyEnum".to_string(), TypeMetadataIR::default())
);
