...
test_deserializer!(
    ...
    ENUM_FILE,
    r#"TWO"#,
    FieldType::Enum("Category".to_string(), TypeMetadataIR::default()),
    "TWO"
);
...
test_deserializer!(
    ...
    "**ONE** is the answer",
    FieldType::Enum("PascalCaseCategory".to_string(), TypeMetadataIR::default()),
    "One"
);
...
test_deserializer!(
    ...
    ENUM_FILE_WITH_DESCRIPTIONS,
    r#"["k1", "k-2-3.1_1"]"#,
    FieldType::List(FieldType::Enum("Category".to_string(), TypeMetadataIR::default()).into(), TypeMetadataIR::default()),
    ["ONE", "TWO"]
);
...
This indicates that there is no relevant tax return form type present on the page.
    "#,
    FieldType::Enum("TaxReturnFormType".to_string(), TypeMetadataIR::default()).as_optional(),
    null
);
...
test_failing_deserializer!(
    ...
    FieldType::Enum("Car".to_string(), TypeMetadataIR::default())
);
...
- **SPAM**
    "#,
    FieldType::Enum("MessageType".to_string(), TypeMetadataIR::default()),
    "SPAM"
);
