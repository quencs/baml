...
test_partial_deserializer!(
    ...
    ```
    "#,
    FieldType::Class("BookAnalysis".to_string(), TypeMetadataIR::default()),
    {
      "bookNames": [
        "brave new world",
        "the lord of the rings",
...
test_partial_deserializer!(
  ...
  FieldType::Class("GraphJson".to_string(), TypeMetadataIR::default()),
  {
    "vertices": [
      {
        "id": "stephanie_morales",
...
test_partial_deserializer!(
  ...
  CHOPPY_BAML_FILE,
  TRIMMED_CHOPPY_RESULT,
  FieldType::union(vec![FieldType::Class("GraphJson".to_string(), TypeMetadataIR::default()), FieldType::Class("GraphJson".to_string(), TypeMetadataIR::default()).as_list(), FieldType::Class("Error".to_string(), TypeMetadataIR::default())]),
  {
    "vertices": [
      {
        "id": "stephanie_morales",
...
test_partial_deserializer!(
  ...
  CHOPPY_BAML_FILE,
  TRIMMED_CHOPPY_RESULT,
  FieldType::union(vec![FieldType::Class("GraphJson".to_string(), TypeMetadataIR::default()), FieldType::Class("ErrorBasic".to_string(), TypeMetadataIR::default())]),
  {
    "vertices": [
      {
        "id": "stephanie_morales",
