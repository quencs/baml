...
use super::{stream_type_to_rb, type_to_rb};
use crate::{
    functions::{FunctionArgRb, FunctionRb},
    package::CurrentRenderPackage,
};

pub fn ir_function_to_rb(function: &FunctionNode, pkg: &CurrentRenderPackage) -> FunctionRb {
    FunctionRb {
        documentation: None,
