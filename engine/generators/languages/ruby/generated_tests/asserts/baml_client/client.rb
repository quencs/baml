  ...
  class BamlSyncClient
      ...
      def PersonTest(
          *varargs,
          ...
          if varargs.any?
              raise ArgumentError.new("PersonTest may only be called with keyword arguments")
          end

          options = @options.merge_options(BamlCallOptions.from_hash(baml_options))

          result = options.call_function_sync(function_name: "PersonTest", args: {
  ...
  class BamlStreamClient
      ...
      def PersonTest(
          *varargs,
          ...
          ctx, result = options.create_sync_stream(function_name: "PersonTest", args: {
