...
pub fn ir_union_to_go<'a>(union: &FieldType, pkg: &'a CurrentRenderPackage,lookup: &impl TypeLookups) -> Option<crate::generated_types::UnionGo<'a>> {
...
pub fn ir_union_to_go_stream<'a>(union: &FieldType, pkg: &'a CurrentRenderPackage, lookup: &impl TypeLookups) -> Option<crate::generated_types::UnionGo<'a>> {
