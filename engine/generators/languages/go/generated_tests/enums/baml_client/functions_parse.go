...
func (*parse) ConsumeTestEnum(ctx context.Context, text string, opts ...CallOptionFunc) (types.TestEnum, error) {
...
func (*parse) FnTestAliasedEnumOutput(ctx context.Context, text string, opts ...CallOptionFunc) (types.TestEnum, error) {
