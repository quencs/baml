...
impl BamlClient {
    ...
    pub async fn bar(
        &self,x: i64,
    ) -> BamlResult<crate::types::Union2ExampleOrExample2> {
    ...
    pub async fn bar_stream(
        &self,x: i64,
    ) -> BamlResult<impl futures::Stream<Item = BamlResult<baml_client_rust::StreamState<crate::stream_state::Union2ExampleOrExample2>>> + Send + Sync> {
        let mut context = BamlContext::new();context = context.set_arg("x", x)?;
