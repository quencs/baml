...
class TypeBuilder:
    ...
    def get_enum(self, name: str) -> EnumBuilder: ...
    def add_class(self, name: str) -> ClassBuilder: ...
    def get_class(self, name: str) -> ClassBuilder: ...
    ...
    def add_baml(self, baml: str) -> None: ...
...
class EnumBuilder:
    def list_values(self) -> List[Tuple[str, EnumValueBuilder]]: ...
    def get_value(self, name: str) -> EnumValueBuilder: ...
    def add_value(self, name: str) -> EnumValueBuilder: ...
    def remove_value(self, name: str) -> None: ...
    def set_alias(self, alias: Optional[str]) -> EnumBuilder: ...
    def alias(self) -> Optional[str]: ...
    def set_description(self, description: Optional[str]) -> EnumBuilder: ...
    def description(self) -> Optional[str]: ...
    def field(self) -> FieldType: ...
    def source(self) -> Literal["baml", "dynamic"]: ...

class EnumValueBuilder:
    def set_alias(self, alias: Optional[str]) -> EnumValueBuilder: ...
    def alias(self) -> Optional[str]: ...
    def set_skip(self, skip: Optional[bool] = True) -> EnumValueBuilder: ...
    def skip(self) -> bool: ...
    def set_description(self, description: Optional[str]) -> EnumValueBuilder: ...
    def description(self) -> Optional[str]: ...
    def source(self) -> Literal["baml", "dynamic"]: ...
...
class ClassBuilder:
    ...
    def get_property(self, name: str) -> ClassPropertyBuilder: ...
    def remove_property(self, name: str) -> None: ...
    def reset(self) -> None: ...
    def source(self) -> Literal["baml", "dynamic"]: ...
    def alias(self) -> Optional[str]: ...
    def set_alias(self, alias: Optional[str]) -> ClassBuilder: ...

class ClassPropertyBuilder:
    def type(self) -> FieldType: ...
    def set_type(self, field_type: FieldType) -> ClassPropertyBuilder: ...
    def alias(self) -> Optional[str]: ...
    def set_alias(self, alias: Optional[str]) -> ClassPropertyBuilder: ...
    def description(self) -> Optional[str]: ...
    def set_description(self, description: Optional[str]) -> ClassPropertyBuilder: ...
    @property
    def source(self) -> Literal["baml", "dynamic"]: ...
