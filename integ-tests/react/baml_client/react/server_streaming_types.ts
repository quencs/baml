...
export type StreamingServerTypes = {
  ...
  MakeClassWithBlockDone: partial_types.ClassWithBlockDone,
  ...
  NestedAlias: ((number | null) | (string | null) | (boolean | null) | (number | null) | (string | null)[] | (Record<string, (string | null)[]> | null)),
