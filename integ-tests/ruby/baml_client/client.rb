  ...
  class BamlSyncClient
      ...
      def StreamTest(
          *varargs,
          ...
          if varargs.any?
              raise ArgumentError.new("StreamTest may only be called with keyword arguments")
          end

          options = @options.merge_options(BamlCallOptions.from_hash(baml_options))

          result = options.call_function_sync(function_name: "StreamTest", args: {
  ...
  class BamlStreamClient
      ...
      def StreamTest(
          *varargs,
          ...
          ctx, result = options.create_sync_stream(function_name: "StreamTest", args: {
