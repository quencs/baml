  ...
  class BamlSyncClient
      ...
      def TestCompoundCombinedTimeouts(
          *varargs,
          ...
          if varargs.any?
              raise ArgumentError.new("TestCompoundCombinedTimeouts may only be called with keyword arguments")
          end

          options = @options.merge_options(BamlCallOptions.from_hash(baml_options))

          result = options.call_function_sync(function_name: "TestCompoundCombinedTimeouts", args: {
              input: input,
          })
      ...
      def TestCompoundRequestTimeout(
          *varargs,
          ...
          if varargs.any?
              raise ArgumentError.new("TestCompoundRequestTimeout may only be called with keyword arguments")
          end

          options = @options.merge_options(BamlCallOptions.from_hash(baml_options))

          result = options.call_function_sync(function_name: "TestCompoundRequestTimeout", args: {
              input: input,
          })
      ...
      def TestCompoundTotalTimeout(
          *varargs,
          ...
          if varargs.any?
              raise ArgumentError.new("TestCompoundTotalTimeout may only be called with keyword arguments")
          end

          options = @options.merge_options(BamlCallOptions.from_hash(baml_options))

          result = options.call_function_sync(function_name: "TestCompoundTotalTimeout", args: {
              input: input,
          })
  ...
  class BamlStreamClient
      ...
      def TestCompoundCombinedTimeouts(
          *varargs,
          ...
          ctx, result = options.create_sync_stream(function_name: "TestCompoundCombinedTimeouts", args: {
              input: input,
          })
      ...
      def TestCompoundRequestTimeout(
          *varargs,
          ...
          ctx, result = options.create_sync_stream(function_name: "TestCompoundRequestTimeout", args: {
              input: input,
          })
      ...
      def TestCompoundTotalTimeout(
          *varargs,
          ...
          ctx, result = options.create_sync_stream(function_name: "TestCompoundTotalTimeout", args: {
              input: input,
          })
