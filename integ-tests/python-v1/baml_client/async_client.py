...
class BamlAsyncClient:
    ...
    async def TestCaching(self, input: str,not_cached: str,
        ...
        if 'on_tick' in baml_options:
            ...
            return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
    async def TestCompoundCombinedTimeouts(self, input: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="TestCompoundCombinedTimeouts", args={
                "input": input,
            })
            return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
    async def TestCompoundRequestTimeout(self, input: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="TestCompoundRequestTimeout", args={
                "input": input,
            })
            return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
    async def TestCompoundTotalTimeout(self, input: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.TestCompoundTotalTimeout(input=input,
                baml_options=baml_options)
            return await stream.get_final_response()
        else:
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="TestCompoundTotalTimeout", args={
                "input": input,
            })
            return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def TestCompoundCombinedTimeouts(self, input: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="TestCompoundCombinedTimeouts", args={
            "input": input,
        })
        return baml_py.BamlStream[str, str](
          result,
    ...
    def TestCompoundRequestTimeout(self, input: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="TestCompoundRequestTimeout", args={
            "input": input,
        })
        return baml_py.BamlStream[str, str](
          result,
    ...
    def TestCompoundTotalTimeout(self, input: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="TestCompoundTotalTimeout", args={
            "input": input,
        })
        return baml_py.BamlStream[str, str](
          result,
...
class BamlHttpRequestClient:
    ...
    async def TestCompoundCombinedTimeouts(self, input: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="TestCompoundCombinedTimeouts", args={
            "input": input,
        }, mode="request")
        return result
    async def TestCompoundRequestTimeout(self, input: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="TestCompoundRequestTimeout", args={
            "input": input,
        }, mode="request")
        return result
    async def TestCompoundTotalTimeout(self, input: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="TestCompoundTotalTimeout", args={
            "input": input,
        }, mode="request")
        return result
    async def TestFallbackClient(self, 
