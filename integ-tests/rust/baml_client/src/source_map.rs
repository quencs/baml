...
pub fn baml_source_files() -> HashMap<&'static str, &'static str> {
    ...
    map.insert("baml_src/clients.baml", r###"retry_policy Bar {
  max_retries 3
  strategy {
...
"###);
    map.insert("baml_src/custom-task.baml", r###"class BookOrder {
...
[Airline Name] Customer Service
    ...
    map.insert("baml_src/fiddle-examples/audio/audio.baml", r###"function DescribeAudio(audio: audio) -> string {
  client GPT4o
  prompt #"
...
"###);
    map.insert("baml_src/fiddle-examples/chain-of-thought.baml", r###"class Email {
    subject string
    body string
    from_address string
}
...
function GetOrderInfo(email: Email) -> OrderInfo {
  ...
  "#
    ...
    map.insert("baml_src/fiddle-examples/chat-roles.baml", r###"// This will be available as an enum in your Python and Typescript code.
enum Category2 {
    Refund
    CancelOrder
    TechnicalSupport
...
function ClassifyMessage2(input: string) -> Category {
  ...
  "#
    ...
    map.insert("baml_src/fiddle-examples/classify-message.baml", r###"// This will be available as an enum in your Python and Typescript code.
enum Category {
    Refund
    CancelOrder
    TechnicalSupport
...
"###);
    map.insert("baml_src/fiddle-examples/extract-names.baml", r###"function ExtractNames(input: string) -> string[] {
  client GPT4
  prompt #"
...
"###);
    map.insert("baml_src/fiddle-examples/extract-receipt-info.baml", r###"class ReceiptItem {
  name string
  description string?
  quantity int
  price float
...
"###);
    map.insert("baml_src/fiddle-examples/images/image.baml", r###"function DescribeImage(img: image) -> string {
  client GPT4o
  prompt #"
...
"###);
    map.insert("baml_src/fiddle-examples/symbol-tuning.baml", r###"enum Category3 {
    Refund @alias("k1")
...
function ClassifyMessage3(input: string) -> Category {
  ...
  "#
    ...
    map.insert("baml_src/formatter/test-comments.baml", r###"class FormatterTest0 {
...
class FormatterTest3 {
  ...
  // Ut enim ad minim veniam
    ...
    map.insert("baml_src/generators.baml", r###"generator lang_python {
...
"###);
    map.insert("baml_src/test-files/abort-handlers/abort-handlers.baml", r###"// Test functions for abort handler functionality
...
function ExtractName(text: string) -> string {
  ...
  "#
    ...
    map.insert("baml_src/test-files/aliases/aliased-inputs.baml", r###"
class InputClass {
...
"###);
    map.insert("baml_src/test-files/aliases/classes.baml", r###"class TestClassAlias {
...
"###);
    map.insert("baml_src/test-files/aliases/enums.baml", r###"enum TestEnum {
...
test FnTestAliasedEnumOutput {
  ...
  args {
    ...
    map.insert("baml_src/test-files/builtin/fetch.baml", r###" // class Todo {
 //   id int
 //   todo string
 //   completed bool
 //   userId int
 ...
 //   std::fetch_value<string>(std::Request {
 //     base_url: UrlEncode("https://en.wikipedia.org/wiki/Special:Search", {search query})
 //   })
 // }

 // function UrlEncode(base_url: string, query_params: map<string, string>) -> string {
 //   client "openai/o3"
 //   prompt #"
 ...
 // }
"###);
    map.insert("baml_src/test-files/comments/comments.baml", r###"// add some functions, classes, enums etc with comments all over."###);
    map.insert("baml_src/test-files/constraints/constraints.baml", r###"// These classes and functions test several properties of
// constrains:
//
...
"###);
    map.insert("baml_src/test-files/constraints/contact-info.baml", r###"class PhoneNumber {
...
"###);
    map.insert("baml_src/test-files/constraints/malformed-constraints.baml", r###"class MalformedConstraints {
...
"###);
    map.insert("baml_src/test-files/descriptions/descriptions.baml", r###"
class Nested {
...
function SchemaDescriptions(input: string) -> Schema {
  ...
  "#
    ...
    map.insert("baml_src/test-files/dynamic/client-registry.baml", r###"// Intentionally use a bad key
...
"###);
    map.insert("baml_src/test-files/dynamic/differentiate_unions.baml", r###"class OriginalA {
  value int
}
...
function DifferentiateUnions() -> OriginalA | OriginalB {
  ...
  "#
    ...
    map.insert("baml_src/test-files/dynamic/dynamic.baml", r###"class DynamicClassOne {
  @@dynamic
}
...
"###);
    map.insert("baml_src/test-files/dynamic/dynamic_tests.baml", r###"class DynamicSchema {
  @@dynamic
}
...
test ExtractEntitiesTest {
  ...
  args {    
    ...
    map.insert("baml_src/test-files/dynamic/render_dynamic_class.baml", r###"enum RenderStatusEnum {
  ACTIVE @alias("currently active")
  INACTIVE @alias("currently inactive")
  @@dynamic
}

class RenderTestClass {
  name string
  status RenderStatusEnum
  @@dynamic
}

function RenderDynamicClass(input: RenderTestClass) -> string {
  client GPT35
  prompt #"
    Input class data: {{ input }}
  "#
}"###);
    map.insert("baml_src/test-files/dynamic/render_dynamic_enum.baml", r###"enum RenderTestEnum {
...
function RenderDynamicEnum(bike: RenderTestEnum, other: RenderTestEnum) -> string {
  ...
  "#
    ...
    map.insert("baml_src/test-files/finish_reason_error.baml", r###"client<llm> OpenAIWithFinishReasonError {
  provider openai
  options {
    api_key env.OPENAI_API_KEY
    model "gpt-4"
...
function TestOpenAIWithFinishReasonError(input: string) -> string {
  ...
  "#
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/named-audio.baml", r###"function AudioInput(aud: audio) -> string{
  client Gemini
  prompt #"
    {{ _.role("user") }}
...
"###);
    map.insert("baml_src/test-files/functions/input/named-args/single/named-boolean.baml", r###"
...
test TestFnNamedArgsSingleBool {
  ...
  args {
    myBool true
     ...
     "###);
    map.insert("baml_src/test-files/functions/input/named-args/single/named-class-list.baml", r###"
...
test TestFnNamedArgsSingleStringList {
  ...
  args {
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/named-class-literal-prop.baml", r###"class LiteralClassHello {
  prop "hello"
}
...
test TestFnLiteralClassInputOutput{
  functions [FnLiteralClassInputOutput]
  args {
    input {
      prop "hello"
    }
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/named-class-literal-union-prop.baml", r###"class LiteralClassOne {
  prop "one"
}
...
test TestFnLiteralUnionClassInputOutput{
  functions [FnLiteralUnionClassInputOutput]
  args {
    input {
      prop "one"
    }
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/named-class.baml", r###"class NamedArgsSingleClass {
  key string
  key_two bool
  key_three int
...
function TestMulticlassNamedArgs(myArg: NamedArgsSingleClass, myArg2: NamedArgsSingleClass) -> string {
  ...
  "#
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/named-enum-list.baml", r###"enum NamedArgsSingleEnumList {
  ONE
  TWO
}
...
test TestFnNamedArgsSingleEnumList {
  ...
  args {
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/named-enum.baml", r###"enum NamedArgsSingleEnum {
  ONE
  TWO
}
...
test FnTestNamedArgsSingleEnum {
  ...
  args {
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/named-float.baml", r###"function TestFnNamedArgsSingleFloat(myFloat: float) -> string {
  client GPT35
  prompt #"
...
"###);
    map.insert("baml_src/test-files/functions/input/named-args/single/named-image-list.baml", r###"function TestImageListInput(imgs: image[]) -> string{
  client GPT4o
  prompt #"
    {{ _.role("user") }}
...
"###);
    map.insert("baml_src/test-files/functions/input/named-args/single/named-image.baml", r###"function TestImageInput(img: image) -> string{
  client Claude
  prompt #"
    {{ _.role("user") }}
...
test image_base64_data_url {
  ...
  args {
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/named-int.baml", r###"// test for int
...
"###);
    map.insert("baml_src/test-files/functions/input/named-args/single/named-literal-bool.baml", r###"function TestNamedArgsLiteralBool(myBool: true) -> string {
  client GPT35
  prompt #"
    Return this value back to me: {{myBool}}
  "#
...
test TestFnNamedArgsLiteralBool {
  ...
  args {
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/named-literal-int.baml", r###"function TestNamedArgsLiteralInt(myInt: 1) -> string {
  client GPT35
  prompt #"
    Return this value back to me: {{myInt}}
  "#
...
test TestFnNamedArgsLiteralInt {
  ...
  args {
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/named-literal-string.baml", r###"function TestNamedArgsLiteralString(myString: "My String") -> string {
  client GPT35
  prompt #"
...
test TestFnNamedArgsLiteralString {
  ...
  args {
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/named-map-string-to-class.baml", r###"class StringToClassEntry {
  word string
}
// test string
...
"###);
    map.insert("baml_src/test-files/functions/input/named-args/single/named-map-string-to-map.baml", r###"// test string
...
test TestFnNamedArgsSingleMapStringToMap {
  ...
  args {
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/named-map-string-to-string.baml", r###"// test string
...
"###);
    map.insert("baml_src/test-files/functions/input/named-args/single/named-pdf.baml", r###"function PdfInput(pdf: pdf) -> string{
  client GPT4o
  prompt #"
    {{ _.role("user") }}

   Describe the contents of this PDF document and what it is about in 15 words or less.
    
    {{ pdf }}
  "#   
}  

function PdfInputOpenai(pdf: pdf, prompt: string) -> string{
  client GPT4o
  prompt #"
    {{ _.role("user") }}

   State the key idea of the research paper in 10 words or less.
    
    {{ pdf }}
  "#   
}  

function PdfInputAnthropic(pdf: pdf) -> string{
  client Claude
  prompt #"
    {{ _.role("user") }}

    Analyze this PDF document and provide a brief summary in 3-4 words.
    
    {{ pdf }}
  "#
}

function PdfInputVertex(pdf: pdf) -> string{
  client Vertex
  prompt #"
    {{ _.role("user") }}

    Describe the contents of this PDF document and what it is about in 5 words or less.
    
    {{ pdf }}
  "#
}
       
test TestFilePdfInput{
  functions [PdfInput]
  args {
    pdf{ 
      file "../../../../../dummy.pdf"
...
test TestFilePdfInputUrl{
  functions [PdfInput]
  args {
    pdf{ 
      url "https://www.usenix.org/system/files/conference/nsdi13/nsdi13-final85.pdf"
    }
  }  
}

test TestFilePdfInputUrlVertex{
  functions [PdfInputVertex]
  args {
    pdf{ 
      url "https://arxiv.org/pdf/2305.08675"
    }
  }  
}

test TestFilePdfInputWithMediaType{
  functions [PdfInput]
  args {
    pdf{ 
      file "../../../../../dummy.pdf"
...
test TestDataURLPdfInput{
  functions [PdfInput]
  args {
    pdf{
      base64 "data:application/pdf;base64,"
      }
  }
} "###);
    map.insert("baml_src/test-files/functions/input/named-args/single/named-string-list.baml", r###"// string[]
...
"###);
    map.insert("baml_src/test-files/functions/input/named-args/single/named-string-optional.baml", r###"
...
"###);
    map.insert("baml_src/test-files/functions/input/named-args/single/named-string.baml", r###"// test string
...
"###);
    map.insert("baml_src/test-files/functions/input/named-args/single/named-video.baml", r###"function VideoInputGemini(vid: video) -> string{
  client Gemini
  prompt #"
    {{ _.role("user") }}
...
function VideoInputVertex(vid: video) -> string{
  client Vertex
  prompt #"
    {{ _.role("user") }}
...
test TestFileVideoInput{
  functions [VideoInputGemini]
  args {
    vid{ 
      file "../../../../../sample-5s.mp4"
    }
...
test TestFileVideoInputWithMediaType{
  functions [VideoInputGemini]
  args {
    vid { 
      file "../../../../../sample-5s.mp4"
...
test TestFileVideoInputWithUrl{
  functions [VideoInputGemini]
  args {
    vid { 
...
test TestFileVideoInputWithUrlVertex{
  functions [VideoInputVertex]
  args {
    vid { 
      url "https://youtu.be/dQw4w9WgXcQ?si=aQdfsK0DdcDtCCud"
    ...
    map.insert("baml_src/test-files/functions/input/named-args/single/testcase_audio.baml", r###"test TestAudioInput {
  functions [AudioInput]
  args {
    aud {
...
"###);
    map.insert("baml_src/test-files/functions/output/allowed_optionals.baml", r###"class OptionalListAndMap {
  p string[]?
  q map<string, string>?
}
...
function AllowedOptionals(optionals: OptionalListAndMap) -> OptionalListAndMap {
  ...
  "#
    ...
    map.insert("baml_src/test-files/functions/output/big-integers.baml", r###"
class BigNumbers {
  a int
  b float
}
...
test StreamingCompoundNumbers {
  functions [StreamingCompoundNumbers]
  args {
    digits 10
    yapping true
  }
}"###);
    map.insert("baml_src/test-files/functions/output/boolean.baml", r###"function FnOutputBool(input: string) -> bool {
  client GPT35
  prompt #"
    Return "true"
  "#
...
"###);
    map.insert("baml_src/test-files/functions/output/class-dynamic.baml", r###"class Person {
  name string?
  hair_color Color?
...
function ExtractHobby(text: string) -> Hobby[] {
  ...
  prompt #"
   ...
   "#
    ...
    map.insert("baml_src/test-files/functions/output/class-list.baml", r###"function FnOutputClassList(input: string) -> TestOutputClass[] {
  client GPT35
  prompt #"
...
"###);
    map.insert("baml_src/test-files/functions/output/class-nested.baml", r###"class TestClassNested {
  prop1 string
  prop2 InnerClass
}
...
"###);
    map.insert("baml_src/test-files/functions/output/class-with-enum.baml", r###"enum EnumInClass {
  ONE
  TWO
}
...
"###);
    map.insert("baml_src/test-files/functions/output/class.baml", r###"class TestOutputClass {
...
"###);
    map.insert("baml_src/test-files/functions/output/enum-list.baml", r###"function FnEnumListOutput(input: string) -> EnumOutput[] {
  client GPT35
  prompt #"
...
"###);
    map.insert("baml_src/test-files/functions/output/enum.baml", r###"/// An enum with three values,
/// ONE, TWO and THREE.
enum EnumOutput {
  ...
  /// The second enum.
  TWO @alias("two") @description("two")
  THREE @alias("hi") @description("three")
...
"###);
    map.insert("baml_src/test-files/functions/output/int.baml", r###"function FnOutputInt(input: string) -> int {
  client GPT35
  prompt #"
...
"###);
    map.insert("baml_src/test-files/functions/output/literal-boolean.baml", r###"function FnOutputLiteralBool(input: string) -> false {
  client GPT35
  prompt #"
...
"###);
    map.insert("baml_src/test-files/functions/output/literal-int.baml", r###"function FnOutputLiteralInt(input: string) -> 5 {
  client GPT35
  prompt #"
...
"###);
    map.insert("baml_src/test-files/functions/output/literal-or-null.baml", r###"class ClassForNullLiteral {
  a "hi"
}
...
test NullLiteralClassHello {
    ...
    map.insert("baml_src/test-files/functions/output/literal-string.baml", r###"function FnOutputLiteralString(input: string) -> "example output" {
  client GPT35
  prompt #"
...
"###);
    map.insert("baml_src/test-files/functions/output/literal-unions.baml", r###"function LiteralUnionsTest(input: string) -> 1 | true | "string output" {
  client GPT35
  prompt #"
...
"###);
    map.insert("baml_src/test-files/functions/output/map-enum-key.baml", r###"enum MapKey {
  A
  B
  C
}
...
"###);
    map.insert("baml_src/test-files/functions/output/map-literal-union-key.baml", r###"function InOutLiteralStringUnionMapKey(
...
"###);
    map.insert("baml_src/test-files/functions/output/mutually-recursive-classes.baml", r###"class Tree {
  data int
  children Forest
}
...
test TestTree {
  ...
  args {
    ...
    map.insert("baml_src/test-files/functions/output/optional-class.baml", r###"class ClassOptionalOutput {
  prop1 string
  prop2 string
}
...
"###);
    map.insert("baml_src/test-files/functions/output/optional.baml", r###"class OptionalTest_Prop1 {
  omega_a string
  omega_b int
}
...
"###);
    map.insert("baml_src/test-files/functions/output/recursive-class.baml", r###"class Node {
  data int
  next Node?
}
...
"###);
    map.insert("baml_src/test-files/functions/output/recursive-type-aliases.baml", r###"class LinkedListAliasNode {
    value int
...
"###);
    map.insert("baml_src/test-files/functions/output/recursive-union.baml", r###"type RecursiveUnion = string | map<string, RecursiveUnion>
...
"###);
    map.insert("baml_src/test-files/functions/output/serialization-error.baml", r###"class DummyOutput {
  nonce string
  nonce2 string
  @@dynamic
}
...
function DummyOutputFunction(input: string) -> DummyOutput {
  ...
  "#
    ...
    map.insert("baml_src/test-files/functions/output/string-list.baml", r###"function FnOutputStringList(input: string) -> string[] {
  client GPT35
  prompt #"
...
"###);
    map.insert("baml_src/test-files/functions/output/type-aliases.baml", r###"type Primitive = int | string | bool | float
...
"###);
    map.insert("baml_src/test-files/functions/output/unions.baml", r###"class UnionTest_ReturnType {
  prop1 string | bool
  prop2 (float | bool)[]
  prop3 (bool[] | int[])
}
...
"###);
    map.insert("baml_src/test-files/functions/prompts/no-chat-messages.baml", r###"
...
function PromptTestStreaming(input: string) -> string {
  client GPT35
  // Keep this one longer to test streaming performance
  prompt #"
...
"###);
    map.insert("baml_src/test-files/functions/prompts/with-chat-messages.baml", r###"
...
test TestSystemAndNonSystemChat2 {
  ...
  args {
    ...
    map.insert("baml_src/test-files/functions/v2/basic.baml", r###"
...
"###);
    map.insert("baml_src/test-files/load-test/memory.baml", r###"
...
"###);
    map.insert("baml_src/test-files/models/deepseek-azure.baml", r###"client<llm> DeepSeekAzure {
    provider openai-generic
    options {
...
"###);
    map.insert("baml_src/test-files/not-valid-json-1559/not-valid-json.baml", r###"class Document1559 {
...
"###);
    map.insert("baml_src/test-files/prompt/field_order.baml", r###"class MaintainFieldOrder {
  a string
  b string
  c string
}
...
"###);
    map.insert("baml_src/test-files/providers/anthropic.baml", r###"function TestAnthropic(input: string) -> string {
  client Claude
  prompt #"
...
function TestThinking(input: string) -> CustomStory {
  ...
  "#
    ...
    map.insert("baml_src/test-files/providers/aws.baml", r###"function TestAws(input: string) -> string {
  client AwsBedrock
  prompt #"
    Write a nice short story about {{ input }}. Keep it to 15 words or less.
  "#
...
"###);
    map.insert("baml_src/test-files/providers/azure.baml", r###"// Test standard Azure GPT-3.5 (should add default max_tokens)
...
test TestAzureFailureCase {
  ...
  args {
    ...
    map.insert("baml_src/test-files/providers/dummy-clients.baml", r###"client OpenAIDummyClient {
  provider openai-generic
  options {
    api_key env.OPENAI_API_KEY
    model "gpt-4o-mini"
...
function TestOpenAIDummyClient(input: string) -> string {
  ...
  "#
    ...
    map.insert("baml_src/test-files/providers/fallback-always-fails.baml", r###"client<llm> FallbackAlwaysFails {
  provider baml-fallback
  options {
    strategy [
...
"###);
    map.insert("baml_src/test-files/providers/gemini.baml", r###"function TestGemini(input: string) -> string {
  client Gemini
  prompt #"
    Write a nice short story about {{ input }}. Keep it to 15 words or less.
  "#
...
function TestGeminiThinking(input: string) -> string {
  client Gemini25ProThinking
  prompt #"
    Analyze this product and tell me what it is: {{ input }}
  "#
}

test TestGeminiThinking {
  functions [TestGeminiThinking]
  args {
    input "A mesh barrier with mounting points designed for vehicle cargo areas"
  }
}
...
"###);
    map.insert("baml_src/test-files/providers/groq.baml", r###"client<llm> Groq {
  provider openai-generic
  options {
...
function TestGroq(input: string) -> string {
  ...
  "#
    ...
    map.insert("baml_src/test-files/providers/ollama.baml", r###"function TestOllama(input: string) -> string? {
  client Ollama
  prompt #"
    Write a nice haiku about {{ input }}
  "#
...
function TestOllamaHaiku(input: string) -> Haiku {
  client Ollama
  prompt #"
    Write a nice haiku about {{ input }}
...
"###);
    map.insert("baml_src/test-files/providers/openai-responses-validation.baml", r###"// OpenAI Responses Provider Validation Tests
...
test ValidateOpenAIResponsesProvider {
  ...
  args {
    ...
    map.insert("baml_src/test-files/providers/openai-responses.baml", r###"// OpenAI Responses API Provider Tests
...
test TestOpenAIResponsesAllRolesTest {
  ...
  args {
    ...
    map.insert("baml_src/test-files/providers/openai-with-anthropic-response.baml", r###"client<llm> OpenAIWithAnthropicResponse {
  provider openai-responses
  options {
    model "gpt-4o"
    client_response_type "openai-responses"
...
test TestOpenAIWithAnthropicResponse {
  ...
  args {
    ...
    map.insert("baml_src/test-files/providers/openai.baml", r###"function PromptTestOpenAI(input: string) -> string {
  client GPT35
  prompt #"
    {{ _.role("user") }}
    Write a nice haiku, given the user input. Make sure to reference the input in the haiku.
...
client<llm> OpenAIWithNullMaxTokens {
  ...
  options {
    ...
    map.insert("baml_src/test-files/providers/openrouter.baml", r###"function TestOpenRouterMistralSmall3_1_24b(input: string) -> string {
...
client<llm> OpenRouterMistralSmall3_1_24b {
  ...
  options {
    ...
    map.insert("baml_src/test-files/providers/strategy.baml", r###"function TestFallbackStrategy(input: string) -> string {
...
"###);
    map.insert("baml_src/test-files/providers/tests.baml", r###"test TestOpenAIShorthand {
...
In conclusion, this story is a reflection on the power of dreams and the responsibilities that come with wielding such influence. It serves as a reminder of the importance of ethical considerations in the face of technological advancement and the need to balance innovation with humanity. The story leaves readers pondering the true cost of a world where dreams are no longer sacred, and the potential for both wonder and danger in the uncharted territories of the mind. But it's also a story about the power of imagination and the potential for change, even in a world where our deepest thoughts are no longer our own. And it's a story about the power of choice, and the importance of fighting for the freedom to dream.
    ...
    map.insert("baml_src/test-files/providers/vertex.baml", r###"function TestVertex(input: string) -> string {
  client Vertex
  prompt #"
    Write a nice short story about {{ input }}. Keep it to 15 words or less.
  "#
...
function TestVertexClaude(input: string) -> string {
  client VertexClaude
  prompt #"
    Write a nice short story about {{ input }}. Keep it to 15 words or less.
  "#
...
test TestVertex {
  functions [TestVertex, TestVertexWithSystemInstructions, TestVertexClaude]
  args {
    input "a cat"
...
"###);
    map.insert("baml_src/test-files/semantic_streaming/semantic_streaming.baml", r###"class SemanticContainer {
...
"###);
    map.insert("baml_src/test-files/strategies/fallback-shorthand.baml", r###"
...
"###);
    map.insert("baml_src/test-files/strategies/fallback.baml", r###"// Happy path fallbacks.
...
"###);
    map.insert("baml_src/test-files/strategies/retry.baml", r###"
...
"###);
    map.insert("baml_src/test-files/strategies/roundrobin.baml", r###""###);
    map.insert("baml_src/test-files/template_string/template_string.baml", r###"
...
"##
"###);
    map.insert("baml_src/test-files/test-asserts-checks/asserts.baml", r###"
...
"###);
    map.insert("baml_src/test-files/testing_pipeline/output-format.baml", r###"class Recipe {
...
"###);
    map.insert("baml_src/test-files/testing_pipeline/resume.baml", r###"class Resume {
    name string
    email string
    phone string
    experience string[]
...
test vaibhav_resume {
    ...
    map.insert("baml_src/test-files/tools/todo-llm.baml", r###"class AddTodoItem {
...
"###);
    map.insert("baml_src/test-files/vm/expr_funcs.baml", r###"// --------------------------------
...
"###);
    map.insert("baml_src/test-files/workflows/workflow_basic.baml", r###"function LLMEcho(input: string) -> string {
    client GPT35
