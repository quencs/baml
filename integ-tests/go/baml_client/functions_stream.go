...
// / Streaming version of StreamTest
func (*stream) StreamTest(ctx context.Context, opts ...CallOptionFunc) (<-chan StreamValue[string, string], error) {
	...
	if err != nil {
		// This should never happen. if it does, please file an issue at https://github.com/boundaryml/baml/issues
		// and include the type of the args you're passing in.
		wrapped_err := fmt.Errorf("BAML INTERNAL ERROR: StreamTest: %w", err)
		panic(wrapped_err)
	}

	internal_ctx := context.Background()
	internal_channel, err := bamlRuntime.CallFunctionStream(internal_ctx, "StreamTest", encoded, callOpts.onTick)
	if err != nil {
		return nil, err
	}
