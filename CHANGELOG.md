...
## [0.91.0](https://github.com/boundaryml/baml/compare/0.90.2..0.91.0) - 2025-07-01

### 🐛 Bug Fixes

- **VSCode Extension**: Fixed proxy handling to support `http-proxy-middleware` v3, improving path rewriting, dynamic target selection, and error handling - ([7756787](https://github.com/boundaryml/baml/commit/77567871900760bd560f24f498a1c6c9d760e7dd)) - hellovai
- **Python**: Added comprehensive pickling support for BAML clients and runtime objects, enabling serialization for distributed applications - ([85f6455](https://github.com/boundaryml/baml/commit/85f6455e9477746cb56f7973a1a0d0d5928673c9)) - Rahul Tiwari
- **CLI**: Fixed environment variable handling in CLI tests - ([344fb8a](https://github.com/boundaryml/baml/commit/344fb8a55ab46df8672904cf89bc5a814161d9c4)) - Rahul Tiwari
- **Runtime**: Resolved blocking issues within runtime execution - ([6784c45](https://github.com/boundaryml/baml/commit/6784c451c01a4cb787beeaab38ed464478362be9)) - Rahul Tiwari
- **JSON Handling**: Fixed rendering of `none` values as `null` in JSON output - ([bfa98e8](https://github.com/boundaryml/baml/commit/bfa98e8ec7f272a888bb581a75c71469c21dfef7)) - Antonio Sarosi

### ✨ New Features

- **Go Language Support**: Enhanced Go client with improved type handling and JSON serialization - ([1771164](https://github.com/boundaryml/baml/commit/1771164ee4b9020a49acc7b3112178963c63ca6f)) - hellovai
- **Boundary Studio**: Updated model integration for Studio v2 - ([843dfde](https://github.com/boundaryml/baml/commit/843dfdeb7e00acb6a464aa26654bc7f94fc382ce)) - aaronvg
- **Linting**: Added warnings for experimental expression features to help developers - ([9fbc9ee](https://github.com/boundaryml/baml/commit/9fbc9ee38336bf08a0c67c02f237a6886e931cd5)) - Greg Hale
- **Code Generation**: Added support for React and TypeScript ESM client generation - ([c68a3b2](https://github.com/boundaryml/baml/commit/c68a3b27d69e0092326fe28d852683e99ab9f1bb)) - Rahul Tiwari

### 🔧 Developer Experience


- **IDE Support**: 
  - Added JetBrains IDE extension (alpha) with LSP4IJ integration - ([984e800](https://github.com/boundaryml/baml/commit/984e800ffe26236963de080820cb43d7f410c826)) - Samuel Lijin
  - Fix gemini in the playground when using the proxy - ([64ff518](https://github.com/boundaryml/baml/commit/64ff518bedb1cd3bf150d9432a991151b8070d46)) - hellovai
  - Added Zed editor extension support - ([f07d944](https://github.com/boundaryml/baml/commit/f07d944a357506b14cdd6549ccf435289ed5ab47)) - egol
- **Development Environment**: 
  - Fixed devcontainer configuration - ([76d61bb](https://github.com/boundaryml/baml/commit/76d61bbb4b87fb1e9b2e4e0d43b9e738cadfe94d)) - Antonio Sarosi
  - Added pre-commit hooks for code formatting - ([b729d36](https://github.com/boundaryml/baml/commit/b729d36e6eda798586bccee86071791c64792ad8)) - Rahul Tiwari
  - Improved development tooling setup - ([d574215](https://github.com/boundaryml/baml/commit/d5742156c35c779403268ddf6f0ceefddfe029cd)) - Antonio Sarosi

### 📚 Documentation & Examples

- **API Documentation**: Enhanced documentation for Llama API integration - ([412eaff](https://github.com/boundaryml/baml/commit/412eaff86895d4c163510651e912b8c5bcd550c9)) - hellovai

- **Citations**: Added academic citation to README for research use - ([a5d56f5](https://github.com/boundaryml/baml/commit/a5d56f5e9029fa6c854c3dde7b843b7c0734c06d)) - Adán

### 🎨 UI/UX Improvements

- **Prompt Fiddle**: 
  - Fixed syntax highlighting issues - ([350914c](https://github.com/boundaryml/baml/commit/350914cf4f2ca7244951eb62f7e1570248ee2482)) - Greg Hale
  - Improved performance in CodeMirror editor - ([a64848c](https://github.com/boundaryml/baml/commit/a64848c9e5f29adad89a558a8ae9c0f3092e1545)) - aaronvg
  - Add support for enviornment variables - ([52b5329](https://github.com/boundaryml/baml/commit/52b532906506dc684d683242ccea871747ec458c)) - Antonio Sarosi
- **Playground**: Various UI improvements and bug fixes
...
- **Python**: Maintained field order when rendering classes


### 📚 Documentation

- **String Literals**: Added string literal examples to tools documentation
