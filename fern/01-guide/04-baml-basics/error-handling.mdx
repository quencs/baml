...
Raised when a request exceeds a configured timeout. See [Configuring Timeouts](/guide/baml-basics/timeouts) for details on timeout configuration.

<ParamField
  path="timeout_type"
  type="string"
>
  The specific timeout that was exceeded. Possible values:
  - `"connect_timeout_ms"`
...
<ParamField
  ...
  type="string"
>
  The name of the client that timed out.
</ParamField>
