    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<events.GoogleSearchFlightsEventCollector>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.GoogleSearchFlights(
          departure_id,arrival_id,adults,children,outbound_date,return_date,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<events.TalkToUserEventCollector>
          ...
          // Check if onTick is provided - route through streaming if so
          if (options.onTick) {
          const stream = this.stream.TalkToUser(
          message,
          __baml_options__
          );
          ...
          const env: Record<string, string> = Object.fromEntries(
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for LLMChooseTool", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<events.GoogleSearchFlightsEventCollector>
              ...
              console.error("Error in onTick callback for GoogleSearchFlights", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<events.MainEventCollector>
              ...
              console.error("Error in onTick callback for Main", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<events.TalkToUserEventCollector>
              ...
              console.error("Error in onTick callback for TalkToUser", error);
              }
              }
              };
              }
